...
public class LawUniversity extends University implements Inventory, Workers, Students, Schedule{
    ...
    LawUniversity(){}
    LawUniversity(String name, int year, String address, int countRoom){

...
public class MedicalUniversity extends University implements Inventory, Workers, Students, Schedule{
    ...
    static{
        opisanie="Класс Медицинский Университет, наследуемый от класса Университет. В нем дополнительно введены: список" +
                " инвентаря, информация о сотрудниках, студентах и парах.\n";
    }
    MedicalUniversity(){}
    MedicalUniversity(String name, int year, String address, int countRoom){

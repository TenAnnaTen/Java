...
public class DramaTheatre extends Theatre implements Workers, Tickets, Plays, Sessions{
    ...
    DramaTheatre(){}
    DramaTheatre(String name, int year, String owner, String address, int countRoom){
    ...
    public void changeTickets() {
        ...
        switch (a){
            case 1:
                ...
                String price = s.nextLine().toLowerCase();
    ...
    public void addPlays() {
        System.out.println("Введите название спектакля, который хотите добавить: ");
        String nazva = s.nextLine().toLowerCase();
        plays.add(nazva);
    }

    @Override
    public void delPlays() {
        System.out.println("Введите название удаляемого спектакля: ");
        String nazvanie = s.nextLine().toLowerCase();
        for(String el: plays){

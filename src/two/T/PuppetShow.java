...
public class PuppetShow extends Theatre implements Workers, Tickets, Plays, Sessions{
    ...
    PuppetShow(){}
    PuppetShow(String name, int year, String owner, String address, int countRoom){
